...
function insetLogToField(log){
    ...
    $.each(log, function (key, item) {
        ...
        logLine += "<pre id=\"" + item['id'] + "\" class=\"" + preClass + "\">" + date.toString().slice(0, 24) + " --> " + item['name'] + " --> " + item['eventType'] + "</pre>";
    })
            ...
            <div class=\"form-group\">\
                <div class=\"row\">\
                    ...
                    <div class=\"col-md-2\">\
                        ...
                        <button class=\"btn btn-primary btn-block hidden deployToSpinnaker\" data-pipeline-id=\"" + pipelineId + "\" data-pipeline-config-id=\"" + pipelineConfigId + "\" data-pipeline=\"" + pipeline + "\">Deploy to Spinnaker</button>\
                    </div>\
                    <div class=\"col-md-1\">\
